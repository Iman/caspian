...
| دستاویز | کے لیے استعمال کریں۔ |
|---|---|
| [FAQ.md](https://github.com/Iman/caspian/blob/main/FAQ.md) | عام سوالات اور فالٹ کوڈز |
| [docs/2026-08-29-design.md](https://github.com/Iman/caspian/blob/main/docs/2026-08-29-design.md) | ڈیزائن فیصلے اور ریکارڈ شدہ ثبوت |
| [docs/BEHAVIOUR.md](https://github.com/Iman/caspian/blob/main/docs/BEHAVIOUR.md) | رویے کے منظرنامے اور ٹیسٹ کی حدود |
| [docs/DEFECTS.md](https://github.com/Iman/caspian/blob/main/docs/DEFECTS.md) | معلوم نقائص اور ان کے شواہد |
| [docs/LAYOUT.md](https://github.com/Iman/caspian/blob/main/docs/LAYOUT.md) | راستے، بندرگاہیں، اجازتیں، اور ملکیت |
| [docs/INSTALL.md](https://github.com/Iman/caspian/blob/main/docs/INSTALL.md) | لینکس انسٹالر کا حوالہ |
| [docs/HARDWARE-TEST.md](https://github.com/Iman/caspian/blob/main/docs/HARDWARE-TEST.md) | ہارڈ ویئر ٹیسٹ کا طریقہ کار |
| [internal/netcfg/testdata/PROVENANCE.md](https://github.com/Iman/caspian/blob/main/internal/netcfg/testdata/PROVENANCE.md) | کیپچر پرووننس |
...
| [test/cucumber/README.md](https://github.com/Iman/caspian/blob/main/test/cucumber/README.md) | براؤزر اور API ٹیسٹ |
