...
يوفر Windows وmacOS مثبتات رسومية. يستخدم Linux وRaspberry Pi سكربت التثبيت. راجع دليل نظامك قبل منح صلاحيات المسؤول.
...
[التفاصيل بالإنجليزية](https://github.com/Iman/caspian/wiki/Installation)
