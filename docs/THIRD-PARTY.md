...
[NOTICE](../NOTICE) lists Caspian's linked libraries and distribution files.
...
The complete [upstream GPL license](../third_party/sni-spoofing/LICENSE.txt) and [attribution](../third_party/sni-spoofing/README.md) remain in the repository.
...
The [share-link parser](../third_party/libxray-share/LICENSE) retains its MIT license.
Windows installers also contain official Wintun binaries and self-contained .NET helpers.
Their notices remain under [third_party](../third_party) and are installed beside the application.
