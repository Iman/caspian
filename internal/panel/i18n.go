...
const (
	...
	// The state of the anti-DPI controls, visible without opening the section
	// as the heading's suffix and, while connected, as a line under the status
	// naming what is in force. Added 2026-09-13.
	MsgSNIStateOn           Key = "sni.state_on"
	MsgSNIStateOff          Key = "sni.state_off"
	MsgSNIActiveLabel       Key = "sni.active_label"
	MsgSNIActiveName        Key = "sni.active_name"
	...
	MsgConfigDroppedOne     Key = "config.entries.dropped.one"
	MsgConfigDroppedMany    Key = "config.entries.dropped.many"
	MsgConfigEntryReset     Key = "config.entries.reset"
	MsgSelectBadEntry       Key = "error.selectentry.headline"
	MsgSelectBadEntryAdvice Key = "error.selectentry.advice"
	MsgSaveSelectFailed     Key = "error.saveselect.headline"
	MsgNoticeEntrySelected  Key = "notice.entryselected"
	MsgNoticeEntryReconn    Key = "notice.entryreconnected"
	...
	MsgPasswordHeading     Key = "password.heading"
	MsgPasswordHint        Key = "password.hint"
	MsgPasswordCurrent     Key = "password.current"
	MsgPasswordNew         Key = "password.new"
	MsgPasswordConfirm     Key = "password.confirm"
	MsgPasswordSave        Key = "password.save"
	MsgPasswordWrong       Key = "password.wrong"
	MsgPasswordShort       Key = "password.short"
	MsgPasswordMismatch    Key = "password.mismatch"
	MsgPasswordSaveFailed  Key = "password.savefailed"
	MsgIdentifiersHeading  Key = "identifiers.heading"
	MsgIdentifiersHint     Key = "identifiers.hint"
	MsgIdentifiersUUID     Key = "identifiers.uuid"
	MsgIdentifiersIMEI     Key = "identifiers.imei"
	MsgIdentifiersEmpty    Key = "identifiers.empty"
	MsgIdentifiersGenerate Key = "identifiers.generate"
	MsgIdentifiersCopy     Key = "identifiers.copy"
	MsgIdentifiersWorking  Key = "identifiers.working"
	MsgIdentifiersReady    Key = "identifiers.ready"
	MsgIdentifiersFailed   Key = "identifiers.failed"
	MsgIdentifiersCopied   Key = "identifiers.copied"
	MsgIdentifiersWarning  Key = "identifiers.warning"
	...
	MsgActionWorking              Key = "action.working"
	MsgActionStopping             Key = "action.stopping"
	MsgActionFailed               Key = "action.failed"
	MsgActionStoppedRemote        Key = "action.stoppedremote"
	MsgActionStale                Key = "action.stale"
	...
	MsgCountryMissing             Key = "fault.countrymissing"
	MsgCountryAdvice              Key = "fault.countrymissing.advice"
	MsgCountryAction              Key = "fault.countrymissing.action"
	MsgFaultUnknown               Key = "fault.unknown"
	MsgFaultUnrecognised          Key = "fault.unrecognised"
	MsgTunnelNoHotspot            Key = "fault.tunnelnohotspot"

	// The subscription address and the refresh it feeds. The four headline
	// keys that double as fault sentences are the ones Fault.Key returns.
	MsgConfigSubscriptionLabel  Key = "config.subscription.label"
	MsgConfigSubscriptionHint   Key = "config.subscription.hint"
	MsgConfigSubscriptionSet    Key = "config.subscription.set"
	MsgConfigRefreshButton      Key = "config.refresh.button"
	MsgConfigRefreshDisabled    Key = "config.refresh.disabled"
	MsgRefreshLine              Key = "refresh.line"
	MsgRefreshWhenJustNow       Key = "refresh.when.justnow"
	MsgRefreshWhenMinutes       Key = "refresh.when.minutes"
	MsgRefreshWhenHours         Key = "refresh.when.hours"
	MsgRefreshWhenDays          Key = "refresh.when.days"
	MsgRefreshEntriesOne        Key = "refresh.entries.one"
	MsgRefreshEntriesMany       Key = "refresh.entries.many"
	MsgRefreshUsed              Key = "refresh.used"
	MsgRefreshExpires           Key = "refresh.expires"
	MsgNoticeSubscriptionSaved  Key = "notice.subscriptionsaved"
	MsgNoticeRefreshed          Key = "notice.refreshed"
	MsgNoticeRefreshReconn      Key = "notice.refreshreconnected"
	MsgSaveSubscriptionFailed   Key = "error.savesubscription.headline"
	MsgSubscriptionNotHTTPS     Key = "problem.subscription.nothttps.headline"
	MsgSubscriptionNoHost       Key = "problem.subscription.nohost.headline"
	MsgSubscriptionIPLiteral    Key = "problem.subscription.ipliteral.headline"
	MsgSubscriptionUserinfo     Key = "problem.subscription.userinfo.headline"
	MsgSubscriptionTooLong      Key = "problem.subscription.toolong.headline"
	MsgSubscriptionMalformed    Key = "problem.subscription.malformed.headline"
	MsgSubscriptionAdvice       Key = "problem.subscription.advice"
	MsgRefreshNoURL             Key = "problem.refresh.nourl.headline"
	MsgRefreshNoURLAdvice       Key = "problem.refresh.nourl.advice"
	MsgRefreshNotRunning        Key = "problem.refresh.notrunning.headline"
	MsgRefreshBadAddress        Key = "problem.refresh.badaddress.headline"
	MsgRefreshBadAddressAdvice  Key = "problem.refresh.badaddress.advice"
	MsgRefreshNoAnswer          Key = "problem.refresh.noanswer.headline"
	MsgRefreshNoAnswerAdvice    Key = "problem.refresh.noanswer.advice"
	MsgRefreshTooLarge          Key = "problem.refresh.toolarge.headline"
	MsgRefreshTooLargeAdvice    Key = "problem.refresh.toolarge.advice"
	MsgRefreshNotHTTPS          Key = "problem.refresh.nothttps.headline"
	MsgRefreshNotHTTPSAdvice    Key = "problem.refresh.nothttps.advice"
	MsgRefreshBadStatus         Key = "problem.refresh.badstatus.headline"
	...
	MsgEventRefreshFailed       Key = "event.refreshfailed"
