...
Снимок выше сделан с реально работающей коробки, на Raspberry Pi 5, с поднятым
туннелем и одним подключённым устройством. Русского снимка нет, поэтому здесь
показана английская версия панели. Пароль сети, имя конфигурации и адрес сервера
...
Два пути. Первый для тех, кто хочет это запустить, второй для тех, кто сначала
хочет всё проверить.
...
Движок, это xray-core v1.260327.0, встроенный в бинарник, а не скачиваемый.
...
Единственная цель для v1, это Raspberry Pi. Смотрите
`docs/2026-08-29-design.md`, раздел 2. macOS и Windows названы более поздними
фазами и не собраны. Android и iOS названы как «никогда».
...
Вам нужны два сетевых интерфейса в одной из двух схем. Смотрите
`docs/2026-08-29-design.md`, раздел 4.7.
